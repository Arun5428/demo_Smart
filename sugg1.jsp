	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <li class="nav-item active"><a href="dhome.jsp" class="nav-link">Home</a></li>
	          ...
	          <li class="nav-item"><a href="dusereq.jsp" class="nav-link">User Request</a></li>
	          <li class="nav-item"><a href="Gisol.jsp" class="nav-link">Give Solution </a></li>
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost/smarthealth","root","root");
            PreparedStatement ps=con.prepareStatement("Select * from request where sno='"+sno+"'");
             ...
             %>
             <form action="suggaction1.jsp" method="post">
             <table>
                ...
                <tr><td><label style=" color: white;">Problem Level:<label></td><td><Select name="need">
              ...
              <tr><td style=" color:white;">Drug:</td>
                 <td><input type="text" name="drug" value=""></td></tr>
