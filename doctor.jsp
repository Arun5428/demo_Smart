      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-center">
	        <div class="col-md-8 text-center d-flex align-items-center ftco-animate js-fullheight">
	        	<div class="text mt-5">
                            <span class="subheading" style=" margin-top:-500px;">Welcome Doctor Login!!</span>
                            <br>
                            <br>
...
.login coming-soon form button {
    ...
    box-shadow: none;
                                            ...
                                            <div class="login">
                                                ...
                                                <form action="dloginc.jsp" method="post"  >
              <div class="row">
         
                <div class="col-md-12">
                    
                <fieldset>
                <input name="user" type="text" class="form-control"  name="dname" placeholder="User Name" required="" style=" color: black;">
                </fieldset>
                </div>
                <div class="col-md-12">
                <fieldset>
                <input name="pass" type="password" class="form-control" name="pass" placeholder=" Password" required="">
                </fieldset>
                </div>
                <div class="col-md-12">
                  <fieldset>
                      <button type="submit" id="form-submit" class="button" style=" background-color:#a1dd70; color: whitesmoke; ">Login</button> <a href="dreg.jsp" style=" color: black;">New Doctor</a>
                  </fieldset>
                </div>
              </div>
            </form>
