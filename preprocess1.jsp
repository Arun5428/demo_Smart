	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	         <li class="nav-item active"><a href="ahome.jsp" class="nav-link">Home</a></li>
	          ...
	          <li class="nav-item"><a href="health.jsp" class="nav-link">Health Analysis</a></li>
...
.login coming-soon form button {
    ...
    box-shadow: none;
       ...
       <% Class.forName("com.mysql.jdbc.Driver");
            ...
            <h3 style=" font-size:15px;margin-left: -850px; color:whitesmoke; margin-bottom: -200px;">Total Count: <span style="color: aqua; font-weight:bolder;"><%=Total%></span> <a href="preprocess1.jsp?totalcount=<%=Total%>" style="Color:black; font-size:20px;">Click here Preprocessing</a>  </h3>
           ...
           <%
              ...
              System.out.println(ps);
               ...
               while(rs.next()){
                      ...
                      if(rs.getString("reaction").isEmpty()||rs.getString("type").isEmpty()||rs.getString("route").isEmpty()||rs.getString("brandname").isEmpty()||rs.getString("brandname").isEmpty()){
