      	...
      	<div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-center">
	        <div class="col-md-8 text-center d-flex align-items-center ftco-animate js-fullheight">
             ...
             <table>
                ...
                <tr><td><label style=" color: white;">Select Doctor:<label></td><td><Select name="dname">
                      <% 
                        Class.forName("com.mysql.jdbc.Driver");
                     Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/smarthealth","root","root");
                
                       PreparedStatement query=con.prepareStatement("select * from dreg group by dname");
           ...
           <%}%>
             ...
             <tr><td style=" color:white;">Symptoms:</td>
                 <td><input type="text" name="symp" value=""></td></tr>
              <tr><td style=" color:white;">Diseases:</td>
                 <td><input type="text" name="dise" value=""></td></tr>
