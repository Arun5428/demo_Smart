      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-center">
	        <div class="col-md-8 text-center d-flex align-items-center ftco-animate js-fullheight">
	        	<div class="text mt-5">
                            <span class="subheading" style=" margin-top:-500px;">Welcome Admin Login!!</span>
                            <br>
                            <br>
...
.login coming-soon form button {
    ...
    box-shadow: none;
                                            ...
                                            <div class="login">
                                                ...
                                                <form action="aloginc.jsp" method="post"  >
              <div class="row">
                ...
                <div class="col-md-12">
                  <fieldset>
                      <button type="submit" id="form-submit" class="button" style=" background-color:#a1dd70; color:black; ">Login</button> 
                  </fieldset>
                </div>
              </div>
            </form>
