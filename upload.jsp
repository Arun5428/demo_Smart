      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-center">
	        <div class="col-md-8 text-center d-flex align-items-center ftco-animate js-fullheight">
	        	<div class="text mt-5">
                            <span class="subheading" style=" margin-bottom: -260px;">Upload DataSet!!</span>
                           <br>
                            <br>
                             <style>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <fieldset>
                     ...
                     <input name="file" type="file" class="form-control"  placeholder="Upload DataSet" required="" style=" color: black;">
                  </fieldset>
                </div>
                ...
                <div class="col-md-12">
                  <fieldset>
                      <button type="submit" id="form-submit" class="button" style=" background-color:#a1dd70; color:black; ">Submit</button> 
                  </fieldset>
                </div>
              </div>
            </form>
